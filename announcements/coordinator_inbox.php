...
$coordinator_dept = $_SESSION['department_id'];
...
<div class="main-container">
    <nav class="sidebar"> 
        ...
        <ul>
            <li><a href="../coordinator/coordinator_panel.php"><i class="bi bi-speedometer2"></i> <span class="menu-text">Dashboard</span></a></li>
            <li><a href="../documents/documents.php"><i class="bi bi-folder"></i> <span class="menu-text">Documents</span></a></li>
            <li><a href="../coordinator/monitoring.php"><i class="bi bi-clipboard-data"></i> <span class="menu-text">Monitoring</span></a></li>
            <li><a href="../partnership/partnership.php"><i class="bi bi-handshake"></i> <span class="menu-text">Partnership</span></a></li>
            <li class="active"><a href="coordinator_inbox.php"><i class="bi bi-envelope-paper"></i> <span class="menu-text">Announcements</span></a></li>
    ...
    <div class="content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <div class="department-info">
                    ...
                    <span class="department-badge"><?php echo escape($department['name']); ?></span>
                </div>
            </div>
        ...
        <?php if (empty($sent_announcements)): ?>
            <div class="empty-state">
                ...
                <p>You haven't sent any announcements yet. Click the button above to send your first announcement to students in your department.</p>
            </div>
        <?php else: ?>
                    ...
                    <div class="card announcement-card">
                        ...
                        <div class="announcement-body">
                            <div class="announcement-meta">
                                ...
                                <?php echo (int)$announcement['recipient_count']; ?> students
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="sendAnnouncementModalLabel">Send Announcement to Students</h5>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        This announcement will be sent to all students in the <strong><?php echo escape($department['name']); ?></strong> department.
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="message" name="message" rows="6" required 
                                  placeholder="Enter your announcement message for students..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" name="send_announcement" class="btn btn-primary">
                        <i class="bi bi-send"></i> Send to Department
                    </button>
                </div>
            </form>
        </div>
